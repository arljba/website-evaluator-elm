		...
		switch (msg.$) {
			...
			case 'ExpandDomainContent':
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$none);
			case 'ExpandSpeedContent':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{showSpeedDetails: !model.showSpeedDetails}),
					$elm$core$Platform$Cmd$none);
...
var $author$project$Main$viewExpandSpeed = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('speed-content-section')
			]),
		_List_fromArray(
			[
				A2(
								...
								_List_fromArray(
									[
										...
										$elm$core$String$concat(
											_List_fromArray(
												[
													A2($myrho$elm_round$Round$round, 2, model.speedDetails.serverResponseTime / 1000),
													' Sekunden'
												])))
									]))
							]))
								...
								_List_fromArray(
									[
										...
										$elm$core$String$concat(
											_List_fromArray(
												[
													A2($myrho$elm_round$Round$round, 2, model.speedDetails.firstContentfulPaint / 1000),
													' Sekunden'
												])))
									]))
							]))
								...
								_List_fromArray(
									[
										...
										$elm$core$String$concat(
											_List_fromArray(
												[
													A2($myrho$elm_round$Round$round, 2, model.speedDetails.timeToInteractive / 1000),
													' Sekunden'
												])))
									]))
							]))
